...
import com.techland.paypay.merchant.factories.EventFactory;
import com.techland.paypay.merchant.factories.SubscriberFactory;
...
public class MerchantListener {
	...
	public MerchantListener(final PayPayListener listenerTools, final SubscriberFactory subscriberFactory) {
	...
	public void handleEvent(@Payload PayPayPayLoad payload) {
		...
		try {
			...
			listenerTools.handleEvent(payload, subscribers, event, new MerchantState());
